/**
 * Relay — Compress Utility
 * LZString compression for efficient storage.
 * LZString by pieroxy.net — MIT License
...
const RelayCompress = (() => {
  ...
  return {
    compress: (str) => LZString.compressToUTF16(str),
    decompress: (str) => LZString.decompressFromUTF16(str),
    compressToBase64: (str) => LZString.compressToBase64(str),
    decompressFromBase64: (str) => LZString.decompressFromBase64(str),
  };
})();
